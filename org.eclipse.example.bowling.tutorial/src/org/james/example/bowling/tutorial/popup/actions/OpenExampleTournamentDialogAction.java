package org.james.example.bowling.tutorial.popup.actions;
...
public class OpenExampleTournamentDialogAction implements IObjectActionDelegate {
	 ...
	 */
	public OpenExampleTournamentDialogAction() {
		super();
	}
	...
	public void run(IAction action) {
		ExampleTournamentDialog dialog = new ExampleTournamentDialog(shell);
		...
		if (sel instanceof TreeSelection) {
			...
			if (firstElement instanceof IFile) {
				try {
					...
					Status status = new Status(IStatus.ERROR, "org.james.example.bowling.tutorial", 0,
				            e.getMessage(), null);
